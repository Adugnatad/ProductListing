                      ...
                      <RadioGroup defaultValue={values.bulletPointsLenth}>
                        <Flex direction={{ sm: "column", md: "row" }}>
                          <Radio
                            ...
                            onChange={() =>
                              setFieldValue("bulletPointsLenth", 1)
                            }
                            mr={7}
                          >
                            150 Char.
                          ...
                          <Radio
                            ...
                            name="bulletPointsLenth"
                            onChange={() =>
                              setFieldValue("bulletPointsLenth", 2)
                            }
                            mr={7}
                          >
                            250 Char.
                          ...
                          <Radio
                            ...
                            name="bulletPointsLenth"
                            onChange={() =>
                              setFieldValue("bulletPointsLenth", 3)
                            }
                            mr={7}
                          >
                            300 Char.
                      ...
                      <RadioGroup defaultValue={values.bulletPointsEmoji}>
                        <Flex direction={{ sm: "column", md: "row" }}>
                          <Radio
                            ...
                            onChange={() =>
                              setFieldValue("bulletPointsEmoji", 1)
                            }
                            mr={7}
                          >
                            None
                          ...
                          <Radio
                            ...
                            name="bulletPointsEmoji"
                            onChange={() =>
                              setFieldValue("bulletPointsEmoji", 2)
                            }
                            mr={7}
                          >
                            Tick (✔️)
                          ...
                          <Radio
                            ...
                            name="bulletPointsEmoji"
                            onChange={() =>
                              setFieldValue("bulletPointsEmoji", 3)
                            }
                            mr={7}
                          >
                            AI Generated (⭐ 🇧🇷🇮🇹)
                      ...
                      <RadioGroup defaultValue={values.descriptionEmoji}>
                        <Flex direction={{ sm: "column", md: "row" }}>
                          <Radio
                            ...
                            onChange={() =>
                              setFieldValue("descriptionEmoji", 1)
                            }
                            mr={7}
                          >
                            None
                          ...
                          <Radio
                            ...
                            name="descriptionEmoji"
                            onChange={() =>
                              setFieldValue("descriptionEmoji", 2)
                            }
                            mr={7}
                          >
                            Tick (✔️)
                          ...
                          <Radio
                            ...
                            name="descriptionEmoji"
                            onChange={() =>
                              setFieldValue("descriptionEmoji", 3)
                            }
                            mr={7}
                          >
                            AI Generated (⭐ 🇧🇷🇮🇹)
